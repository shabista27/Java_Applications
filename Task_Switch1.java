...
public class Task_Switch1 extends JFrame implements KeyListener
{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Task_Switch1 frame = new Task_Switch1();
	...
	public Task_Switch1()
	{
		...
		label1=new JLabel("What Number?",JLabel.CENTER);
		...
		System.out.print("What Number?  " + randomTitle1);
	...
	{
		BufferedWriter br = new BufferedWriter(new FileWriter("C:\\Users\\Shabista\\Desktop\\Task_Switch(w).csv"));
